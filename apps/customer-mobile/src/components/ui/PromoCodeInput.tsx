 ...
 * Allows users to enter and apply promo codes
 */
...
export default function PromoCodeInput({
  ...
  return (
    <View style={styles.container}>
      ...
      {appliedCode ? (
        <View style={styles.appliedContainer}>
          <View style={styles.appliedCodeContainer}>
            <Text style={styles.appliedCodeLabel}>Applied:</Text>
      ...
      {success && !appliedCode && (
        <Text style={styles.successText}>Promo code applied successfully!</Text>
      )}
    </View>
  );
}
